...
class UsuariosModel extends Query{
    ...
    {
        $sql = "SELECT id, nombre, apellido, correo, telefono, dpto, perfil, clave, fecha, rol FROM usuarios WHERE estado = 1";
    ...
    public function registrar($nombre, $apellido, $correo, $telefono, $dpto, $clave, $rol)
    {

     $sql = "INSERT INTO usuarios (nombre, apellido, correo, telefono, dpto, clave, rol) VALUES (?,?,?,?,?,?,?)";
     $datos = array($nombre, $apellido, $correo, $telefono, $dpto, $clave, $rol);
